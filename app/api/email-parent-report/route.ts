...
export async function POST(req: NextRequest) {
  ...
  const html = `
    <div style="font-family: -apple-system, sans-serif; max-width: 560px; color:#111827;">
      ...
      <p style="color:#9ca3af; font-size:12px; margin-top:24px;">This report was generated by Mindspire Lab Classroom on behalf of ${teacherName}.</p>
      <p style="color:#9ca3af; font-size:12px; margin-top:4px;">Please don't reply to this email — for any questions about ${firstName}'s progress, email <a href="mailto:faridah@mindspirelab.com" style="color:#7c3aed;">faridah@mindspirelab.com</a> or reach out directly on WhatsApp.</p>
    </div>
  `
